...
ParticleBunch* STRUCT_Bunch(const BeamData& bdat, double nx1, double nx2, double ny1, double ny2, double dpp, int
	npart);
} // end anonymous namespace

HaloTracker::HaloTracker(AcceleratorModel::Beamline beamline, const BeamData& beamdat) :
	collimate_halo(true), dump_particles(true), use_struct_dist(false), n1x(0), n2x(0), n1y(0), n2y(0), x(0), xp(0), y(
		0), yp(0), dp(0), bdat(beamdat), bline(beamline)
{
}
...
void HaloTracker::SetSTRUCTlimits(double nX1, double nX2, double nY1, double nY2, double dpp)
{
...
ParticleBunch* STRUCT_Bunch(const BeamData& bdat, double nx1, double nx2, double ny1, double ny2, double ddp, int npart)
{
