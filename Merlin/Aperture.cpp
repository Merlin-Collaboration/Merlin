...
Aperture::Aperture(string type, double s, double aper1, double aper2, double aper3, double aper4) :
	...
	ellipHalfHeight(aper4), minRectDim(fmin(aper1, aper2)), minEllipDim(fmin(aper3, aper4)), minDim(min(
	{ aper1, aper2, aper3, aper4 })),
	maxRectDim(fmax(aper1, aper2)), maxEllipDim(fmax(aper3, aper4)), maxDim(max(
	{ aper1, aper2, aper3, aper4 })),
	ellipHalfHeight2(aper4 * aper4), ellipHalfWidth2(aper3 * aper3),
...
OctagonalAperture::OctagonalAperture(string type, double s, double aper1, double aper2, double aper3, double aper4) :
	Aperture(type, s, aper1, aper2, aper3, aper4), angle1(aper3), angle2(aper4),
	const1(rectHalfHeight * tan(angle1) - rectHalfWidth), const2(rectHalfWidth * tan(angle1)),
	const3(rectHalfHeight - const2)
{
