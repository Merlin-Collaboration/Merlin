...
inline AcceleratorComponent::AcceleratorComponent (const string& aName)
	: ModelElement(aName),itsField(nullptr),itsGeometry(nullptr),itsAperture(nullptr),itsWakes(nullptr),position(0),blI(0)
{}

inline AcceleratorComponent::AcceleratorComponent (const string& aName, AcceleratorGeometry* aGeom, EMField* aField)
	: ModelElement(aName),itsField(aField),itsGeometry(aGeom),itsAperture(nullptr),itsWakes(nullptr),position(0),blI(0)
{}
