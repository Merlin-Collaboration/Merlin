...
void LossMapCollimationOutput::Finalise()
{
	...
	cout << "CollimationOutput:: DeadParticles.size() = " <<  DeadParticles.size() << endl;
	...
	cout << "CollimationOutput:: OutputLosses.size() = " << OutputLosses.size() << endl;
	cout << "CollimationOutput:: Total losses = " << total << endl;
}
