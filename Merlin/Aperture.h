...
public:
	...
	void setRectHalfWidth(double aper1)
	{
		...
		minDim = min(
		{ rectHalfWidth, rectHalfHeight, ellipHalfWidth, ellipHalfHeight });
		maxDim = max(
		{ rectHalfWidth, rectHalfHeight, ellipHalfWidth, ellipHalfHeight });
	}
...
public:
	 ...
	 */
	Aperture* getInstance(string type = "RECTELLIPSE", double s = 0.0, double aper1 = 0.0, double aper2 = 0.0,
		double aper3 = 0.0, double aper4 = 0.0);
};
