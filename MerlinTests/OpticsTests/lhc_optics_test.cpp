...
int main(int argc, char* argv[])
{
	...
	while (getline(tfs_file, line)){
		while (line.length()>0 && line[0]==' ') line = line.substr(1,line.length()-1);
		if (line == "") continue;
		...
		for (int i=0; i<52; i++){
			switch(i){
				case 0: liness >> this_line.name;
					this_line.name = StripQuotes(this_line.name);
					break;
				case 1: liness >> this_line.keyword;
					this_line.keyword = StripQuotes(this_line.keyword);
					break;
				case 2: liness >> this_line.s; break;
				case 3: liness >> this_line.l; break;
				case 6: liness >> this_line.k0l; break;
				case 7: liness >> this_line.k1l; break;
				case 8: liness >> this_line.k2l; break;
				case 9: liness >> this_line.k3l; break;
				case 10: liness >> this_line.k4l; break;
				case 17: liness >> this_line.betx; break;
				case 18: liness >> this_line.bety; break;
				case 19: liness >> this_line.alfx; break;
				case 20: liness >> this_line.alfy; break;
				default: liness >> dummy; break;
		...
		if (this_line.keyword == "MULTIPOLE"){
			if (this_line.k0l != 0) this_line.keyword = "SBEND";
			else if (this_line.k1l != 0) this_line.keyword = "QUADRUPOLE";
			else if (this_line.k2l != 0) this_line.keyword = "SEXTUPOLE";
			else if (this_line.k3l != 0) this_line.keyword = "OCTUPOLE";
			else if (this_line.k4l != 0) this_line.keyword = "DECAPOLE";
			else this_line.keyword = "DRIFT";
		}
		if (this_line.keyword == "INSTRUMENT") this_line.keyword = "DRIFT";
		if (this_line.keyword == "TKICKER") this_line.keyword = "DRIFT";
		if (this_line.keyword == "PLACEHOLDER") this_line.keyword = "DRIFT";

		if ((this_line.keyword == "RCOLLIMATOR" ||
			this_line.keyword == "DRIFT")
			&& this_line.l == 0 ) continue;
